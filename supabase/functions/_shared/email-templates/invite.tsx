...
export const InviteEmail = ({
  ...
  <Html lang="fr" dir="ltr">
    <Head />
    <Preview>Vous êtes invité à rejoindre Zonite Market</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <div style={content}>
          ...
          <Text style={text}>
            Vous avez été invité à rejoindre Zonite Market. Cliquez sur le
            bouton ci-dessous pour accepter l'invitation et créer votre compte.
          </Text>
