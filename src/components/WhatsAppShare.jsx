...
export default function WhatsAppShare({ produit, vendeurName }) {
  ...
  return (
    <button
      onClick={handleShare}
      className="flex items-center justify-center gap-2 w-full py-3 rounded-xl text-white text-sm font-bold active:scale-[0.97] transition-transform"
