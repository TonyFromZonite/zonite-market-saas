...
const TikTokIcon = forwardRef(({ size = 20 }, ref) =>
        ...
        <div className="relative z-10 flex flex-col items-center gap-3 md:gap-4 mt-5 md:mt-8 px-3">
          ...
          <div className="flex items-center gap-2.5">
            ...
            {lienWhatsapp && (
              ...
              className="flex items-center gap-1.5 bg-white/10 hover:bg-[#25D366]/30 border border-white/20 rounded-xl px-3 py-1.5 text-white text-xs font-medium transition-all active:scale-95">
