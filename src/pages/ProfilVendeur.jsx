            ...
            <div className="p-4 flex flex-col gap-2.5">
              {socialConfigs["lien_whatsapp"] && (
                <a href={socialConfigs["lien_whatsapp"]} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-3 px-4 py-3 rounded-xl bg-[#25D366]/10 border border-[#25D366]/20 text-[#25D366] font-semibold text-sm active:scale-[0.97] transition-transform">
              ...
              {socialConfigs["lien_facebook"] && (
                <a href={socialConfigs["lien_facebook"]} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-3 px-4 py-3 rounded-xl bg-[#1877F2]/10 border border-[#1877F2]/20 text-[#1877F2] font-semibold text-sm active:scale-[0.97] transition-transform">
                  <Facebook className="w-5 h-5" /> Facebook
                </a>
              )}
              {socialConfigs["lien_tiktok"] && (
                <a href={socialConfigs["lien_tiktok"]} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-3 px-4 py-3 rounded-xl bg-slate-100 border border-slate-200 text-slate-800 font-semibold text-sm active:scale-[0.97] transition-transform">
